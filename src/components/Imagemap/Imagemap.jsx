...
import Controller from "../assets/images/lunar-controller.jpg"
...
const Imagemap = () => {
    ...
    const myFunction2 = () => {
        document.getElementById("aText").innerHTML = Bmap
    }
    const myFunction3 = () => {
    ...
    const myFunction7 = () => {
        document.getElementById("aText").innerHTML = Lanamap
    }
    const myFunction8 = () => {
    ...
    return (
        <div className="imageDiv">
            ...
            <h2 id="text">Change the webpage by interacting with the controller below!</h2>
            <img src = {Controller} alt="Wii remote" id="controller" usemap="#image-map"></img>
            <figcaption>Hello!</figcaption>
            </div>
<map name="image-map">
    <area alt="A" title="A" coords="456,158,21" shape="circle" href="#" onClick={myFunction} id="myAbtn"/>
    <area alt="B" title="B" href="#" coords="493,123,20" shape="circle" onClick={myFunction2}/>
    <area alt="X" title="X" href="#" coords="419,121,20" shape="circle" onClick={myFunction3} />
    <area alt="y" title="y" href="#" coords="456,86,20" shape="circle" onClick={myFunction4} />
    <area alt="Start" title="Start" href="#" coords="356,121,20" shape="circle" onClick={myFunction5} />
    <area alt="Menu" title="Menu" href="#" coords="276,120,21" shape="circle" onClick={myFunction6} />
