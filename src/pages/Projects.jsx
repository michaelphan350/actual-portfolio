        ...
        <div className="projects">
            ...
            <div id="portfolioContainer">
                ...
                <div id="portfolioItems">
                    ...
                    <a href="/" target="_blank" rel="noreferrer noopener" onClick={event => event.preventDefault()}>
                        <p>Deployed Application/Video</p>
                    </a>
                </div>
                <div id="portfolioItems">
                ...
                <div id="portfolioItems">
                    ...
                    <a href="/"target="_blank" className="controllerLink" onClick={event => event.preventDefault()}>Deployed Application/Video</a>
                </div>
            </div>
